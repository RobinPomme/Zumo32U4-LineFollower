...
/**
 * @brief De Gyro klasse slaat de ruwe sensorwaarden op van de gyroscoop.
 *
...
public:
     ...
     * @param gx Ruwe waarde die direct uit de Zumo32U4IMU hardware komt (X-as).
     * @param gy Ruwe waarde die direct uit de Zumo32U4IMU hardware komt (Y-as).
     * @param gz Ruwe waarde die direct uit de Zumo32U4IMU hardware komt (Z-as).
     */
